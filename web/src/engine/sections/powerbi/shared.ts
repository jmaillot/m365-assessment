/**
 * Shared string-shaping helpers for the Power BI collector ports.
 *
 * Mirrors `src/engine/sections/entra/shared.ts` and `src/engine/sections/security/shared.ts`.
 */
...
/**
 * PS `$_.Exception.Message -match '<pattern>'` parity.
 */
