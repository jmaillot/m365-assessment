/**
 * Shared string-shaping helpers for the Entra collector ports.
 *
 * The PS collectors emit report records (PSCustomObjects) that Export-Csv
 * renders; these helpers reproduce that stringification deterministically so
